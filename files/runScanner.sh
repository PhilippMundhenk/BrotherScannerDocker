...
WEBSERVER_PORT="$PORT"
WEBSERVER_LABEL_SCANTOFILE="$RENAME_GUI_SCANTOFILE"
WEBSERVER_LABEL_SCANTOEMAIL="$RENAME_GUI_SCANTOEMAIL"
WEBSERVER_LABEL_SCANTOIMAGE="$RENAME_GUI_SCANTOIMAGE"
WEBSERVER_LABEL_SCANTOOCR="$RENAME_GUI_SCANTOOCR"
