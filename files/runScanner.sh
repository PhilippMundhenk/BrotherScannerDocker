...
WEBSERVER_ENABLE="${WEBSERVER_ENABLE:-$WEBSERVER}"
WEBSERVER_PORT="${WEBSERVER_PORT:-$PORT}"
WEBSERVER_LABEL_SCANTOFILE="${WEBSERVER_LABEL_SCANTOFILE:-$RENAME_GUI_SCANTOFILE}"
WEBSERVER_LABEL_SCANTOEMAIL="${WEBSERVER_LABEL_SCANTOEMAIL:-$RENAME_GUI_SCANTOEMAIL}"
WEBSERVER_LABEL_SCANTOIMAGE="${WEBSERVER_LABEL_SCANTOIMAGE:-$RENAME_GUI_SCANTOIMAGE}"
WEBSERVER_LABEL_SCANTOOCR="${WEBSERVER_LABEL_SCANTOOCR:-$RENAME_GUI_SCANTOOCR}"
if [ "${DISABLE_GUI_SCANTOFILE:-false}" = "true" ]; then
	WEBSERVER_LABEL_SCANTOFILE=""
fi
if [ "${DISABLE_GUI_SCANTOEMAIL:-false}" = "true" ]; then
	WEBSERVER_LABEL_SCANTOEMAIL=""
fi
if [ "${DISABLE_GUI_SCANTOIMAGE:-false}" = "true" ]; then
	WEBSERVER_LABEL_SCANTOIMAGE=""
fi
if [ "${DISABLE_GUI_SCANTOOCR:-false}" = "true" ]; then
